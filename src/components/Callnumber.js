...
export default function Callnumber() {
  ...
  return (
    <>
        {/* ==================== Call Us */}
        <section class="call_panel">
        <Row className="align-items-center">
          <Col md={9}>
            <div className="text_contact">
              <img src="https://www.greatbritishtalent.com/static/css/img/call.png" alt="" />
              <p>{items.cta_heading}</p>
            </div>
          </Col>
          <Col md={3}>
            <button className="call_btn" href="tel:+44 (0)1753 439289 "><svg
